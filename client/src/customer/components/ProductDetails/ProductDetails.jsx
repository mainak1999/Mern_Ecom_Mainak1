        ...
        <div className="bg-white lg:px-20">
            <div className="pt-6">
                ...
                <section className='grid grid-cols-1 lg: grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10'>
                    ...
                    {/* Product info */}
                    <div className="lg:col-span-1 max-auto max-ww-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
                        <div className="lg:col-span-2">
                            <h1 className="flex text-lg lg:text-xl font-semibold text-gray-900">{products.product?.brand}</h1>
                            <h1 className="flex text-lg lg:text-xl text-gray-900 opacity-60 pt-1">{products.product?.title}</h1>
                        </div>
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <p className='opacity-50 text-sm'>56430 Ratings</p>
                            <p className='ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-200'>3870 Reviews</p>
                            </div>
                            ...
                            <form className="mt-10">
                                ...
                                <Button onClick={handleAddToCart} color="secondary" variant="contained" sx={{px:"2rem",py:"1rem",bgcolor: "#9155fd",display: 'flex'}}> 
                                    Add to Cart
                                </Button>
                            </form>
                        </div>
                ...
                {/*Ratings and Reviews*/}
                <section>
                    <h1 className="flex font-semibold text-lg pb-4">Recent Review and Ratings</h1>
                        ...
                        <Grid container spacing={7}>
                            ...
                            <Grid item xs={5}>
                                ...
                                <div className='flex justify-center space-x-3'>
                                    ...
                                    <p className='opacity-60'>56430 Ratings</p>
                                </div>
                                <Box className='mt-5 space-y-3'>
                                 <Grid container justifyContent="center" alignItems="center" gap={2}>
                                    ...
                                    <Grid container justifyContent="center" alignItems="center" gap={2}>
                                        ...
                                        <Grid item xs={7}>
                                            <LinearProgress sx={{bgcolor:"#d0d0d0", borderRadius:4, height:7}} variant="determinate" value={35}  />
                                        </Grid>
                                    </Grid>
                                    <Grid container justifyContent="center" alignItems="center" gap={2}>
                                        <Grid item xs={2}>
